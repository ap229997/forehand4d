...
class TFClassifier(nn.Module):
    def __init__(self, opt, inp_dim):
        ...
        ts, nq = opt.max_motion_length, opt.num_quantizers
        ...
        # self.dec = TransformerDecoderLayer(d_model=opt.code_dim, nhead=1, batch_first=True, dropout=opt.dropout)
        # self.decoder = TransformerDecoder(self.dec, num_layers=1)
