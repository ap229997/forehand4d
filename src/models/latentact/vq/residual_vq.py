...
from src.models.latentact.vq.quantizer import QuantizeEMAReset, QuantizeEMA
...
class ResidualVQ(nn.Module):
    ...
    def quantize(self, x, return_latent=False, **kwargs):
        all_indices = []
        quantized_out = 0.
        residual = x
        all_codes = []
        for quantizer_index, layer in enumerate(self.layers):
            ...
            quantized, *rest = layer(residual, return_idx=True, **kwargs) #single quantizer
