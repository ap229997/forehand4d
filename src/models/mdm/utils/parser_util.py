...
def add_base_options(parser):
    ...
    group.add_argument("--num_workers", default=0, type=int, help="Number of workers for data loader.")
...
def get_cond_mode(args):
    ...
    if args.get('unconstrained', False):
        cond_mode = 'no_cond'
    elif dataset in ['kit', 'humanml']:
        cond_mode = 'text'
        ...
        cond_mode = args.get('cond_mode', 'no_cond')
    else:
        cond_mode = 'action'
    return cond_mode
