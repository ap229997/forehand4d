...
class GaussianDiffusion:
    ...
    def __init__(
        ...
        *,
        ...
        self.l1_loss = lambda a, b: th.abs(a - b)
    ...
    def masked_l2(self, a, b, mask):
        ...
        # print('loss', loss)
        mse_loss_val = loss / (non_zero_elements + 1e-8) # handle division by zero
    ...
    def training_losses(self, model, x_start, t, model_kwargs=None, noise=None, dataset=None, **kwargs):
        """
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
            ...
            # TODO: write a different wrapper for this and inherit from GaussianDiffusion
            terms["model_output"] = model_output
            if not kwargs.get('use_diff_2d', False):
                target = {
