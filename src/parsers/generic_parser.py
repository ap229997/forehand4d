def add_generic_args(parser):
    ...
    parser.add_argument("--setup", type=str, default="p2", help="p2 refers to egocentric, use p1 only for arctic exocentric data")
    ...
    parser.add_argument("--num_threads", type=int, default=8, help="Number of torch threads")
    parser.add_argument(
        "--eval_on",
        type=str,
        default=None,
